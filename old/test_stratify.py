...
def train_wrapper(X, y, im_size, base_pref, backbone='resnet34', loss='categoricalCE',
              ...
              weight_classes=False, kfold=True, use_dropout=False, use_batchnorm=True):
    ...
    if kfold:
        ...
        kfold = MultilabelStratifiedKFold(n_splits=num_folds, shuffle=True, random_state=5)
    ...
    return (val_iou_per_fold, val_loss_per_fold, val_iou_weighted_per_fold, val_f1_per_fold, val_prec_per_fold, val_rec_per_fold, mp_per_class_per_fold, si_per_class_per_fold, oc_per_class_per_fold, rounded_iou_per_fold), time_per_fold, fold_stats
