"""
Inspired by https://github.com/bnsreenu/python_for_microscopists/blob/master/208-simple_multi_unet_model.py
"""
...
# c1 = Conv2Dbn(16, (3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same', use_batchnorm=)(s)

################################################################
def unet_model_transpose(n_classes=3, IMG_HEIGHT=480, IMG_WIDTH=480, IMG_CHANNELS=1, use_dropout=True):
#Build the model
...
################################################################
def unet_model(n_classes=3, IMG_HEIGHT=480, IMG_WIDTH=480, IMG_CHANNELS=1, use_dropout=True):
#Build the model
    inputs = Input((IMG_HEIGHT, IMG_WIDTH, IMG_CHANNELS))
